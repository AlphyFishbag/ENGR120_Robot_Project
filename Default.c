...
#pragma config(Sensor, I2C_1,  Sensor1,        sensorQuadEncoderOnI2CPort,    , AutoAssign )
...
break;
		case state2:
			...
			if(getMotorEncoder(Sensor1) > 1567){
			...
			if ( button2_pushed ) {							//if button 1 is pushed, test_state = state3
